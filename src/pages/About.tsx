    ...
    <>
      <div id="about-container">
        ...
        <div className="right-text-container">
          <h3>{type === "sv" ? `Hur började min resa?` : `How did my journey begin?`}</h3>
          <p>
            {type === "sv" ? `
            Under många år har jag jobbat med yrken som både känts enformiga och monotona. Jag har alltid 
          ...
          <h3>{type === "sv" ? `Varför frontend utveckling?` : `Why frontend development?`}</h3>
          <p>
